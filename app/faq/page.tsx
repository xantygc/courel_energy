...
const faqs = [
  {
    q: "¿Qué es Facturio y para qué sirve?",
    a: "Facturio es un simulador de facturas eléctricas que te permite comparar el coste anual de diferentes tarifas de luz (Iberdrola, Endesa, Octopus Energy, etc.) con tu propio consumo real. Así puedes saber qué tarifa te sale más barata y cuánto ahorrarías cambiando de comercializadora."
  },
  {
      ...
      <div className="app" style={{ maxWidth: 780 }}>
        ...
        <div id="disclaimer" className="card" style={{ marginTop: "3rem", border: "1px solid var(--amber)", background: "var(--amber-dim)", padding: "1.5rem" }}>
          ...
          <p style={{ color: "var(--text)", fontSize: "14px", lineHeight: 1.6, marginTop: "1rem" }}>
            ...
            Facturio es una herramienta de orientación, no un asesor energético.
          </p>
        </div>
      </div>
