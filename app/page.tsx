    ...
    <div className="landing-page" style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "var(--bg)", fontFamily: "var(--font-body)" }}>
      ...
      <header className="main-header">
        ...
        <nav className="main-header-nav">
          <a href="https://github.com/xantygc/courel_energy" target="_blank" rel="noopener noreferrer" className="hide-mobile" style={{ textDecoration: "none", color: "var(--text3)", display: "flex", alignItems: "center", justifyContent: "center", padding: "0.25rem", transition: "color 0.2s" }} title="Ver código en GitHub" onMouseEnter={(e) => e.currentTarget.style.color="var(--text)"} onMouseLeave={(e) => e.currentTarget.style.color="var(--text3)"}>
