    ...
    <div className="landing-page" style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "var(--bg)", fontFamily: "var(--font-body)" }}>
      ...
      <header className="main-header">
        ...
        <nav className="main-header-nav">
          <a href="https://github.com/xantygc/courel_energy" target="_blank" rel="noopener noreferrer" className="hide-mobile github-link" style={{ textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center", padding: "0.25rem" }} title="Ver código en GitHub">
      ...
      <main style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "4rem 2rem", textAlign: "center" }}>
        ...
        <div style={{ maxWidth: "800px", display: "flex", flexDirection: "column", gap: "1.5rem", alignItems: "center" }}>
          ...
          <h1 style={{
            ...
            Registra tu consumo. <br />
            Elige la tarifa que <span style={{ color: "var(--accent)" }}>realmente</span> te conviene.
          </h1>
          ...
          <p style={{
            ...
            Facturio nace de una idea incómoda: entender tu factura de la luz no debería requerir un máster ni un asesor de parte. Registra tus consumos, cruza tus datos con las tarifas del mercado y decide tú — sin que nadie cobre comisión por señalarte la salida. Gratuito, de código abierto, y así seguirá.
          </p>
      ...
      <footer className="footer">
        <div className="footer-inner">
          ...
          <div className="footer-sub">
            Facturio es gratuito y de código abierto.<br />
