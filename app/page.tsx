    ...
    <div className="landing-page" style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "var(--bg)", fontFamily: "var(--font-body)" }}>
      ...
      <header className="main-header">
        ...
        <nav className="main-header-nav">
          <Link href="https://github.com/xantygc/courel_energy" className="btn-sm hide-mobile" style={{ textDecoration: "none", background: "transparent", border: "1px solid var(--border)" }}>
            GitHub
          </Link>
